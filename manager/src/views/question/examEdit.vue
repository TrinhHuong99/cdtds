            ...
            <b-card-text>
                <b-row>
                    <b-col class="mb-1">
                        ...
                        <b-form-checkbox id="checkbox-1" class="mb-1" v-model="questionEditModalData.status" name="checkbox-1" value="1" unchecked-value="0">Xuất bản</b-form-checkbox>
                        ...
                        <b-form-group v-if="questionEditModalData.content_type == 4" label="Số lượng chữ tối thiểu" label-for="basicInput">
                            <b-form-input v-model="questionEditModalData.length_min" placeholder="Số lượng chữ tối thiểu" rows="1" />
                        </b-form-group>
                        <b-form-group v-if="questionEditModalData.content_type == 4" label="Số lượng chữ tối đa" label-for="basicInput">
                            <b-form-input v-model="questionEditModalData.length_max" placeholder="Số lượng chữ tối đa" rows="1" />
                        </b-form-group>
            ...
            <b-card-text>
                <b-row>
                    <b-col class="mb-1">
                        ...
                        <b-form-group v-if="questionModalData.content_type == 4" label="Số lượng chữ tối thiểu" label-for="basicInput">
                            <b-form-input v-model="questionModalData.length_min" placeholder="Số lượng chữ tối thiểu" rows="1" />
                        </b-form-group>
                        <b-form-group v-if="questionModalData.content_type == 4" label="Số lượng chữ tối đa" label-for="basicInput">
                            <b-form-input v-model="questionModalData.length_max" placeholder="Số lượng chữ tối đa" rows="1" />
                        </b-form-group>
                            ...
                            <b-col>
                                ...
                                <draggable v-model="examp.questions" v-bind="dragOptions" :moved="listDrag(examp.id)" class="list-group list-group-flush cursor-move" tag="ul">
                                    <transition-group type="transition" name="flip-list">
                                        <b-list-group-item v-for="(listItem) in examp.questions" :key="listItem.id" tag="li" :class="{disable: !listItem.status}">
                                            <div class="">
                                                ...
                                                <div class="question-item" v-if="listItem.content_type == 4">
    ...
    methods: {
        ...
        editQuestion() {
            ...
            this.$http.post('/edit-questions', {
                ...
                length_min: this.questionEditModalData.length_min,
                length_max: this.questionEditModalData.length_max,
                status: this.questionEditModalData.status,
            })
            .then(res => {
                if (res.data.code === 1) {
                    ...
                    self.examPart[indexPart].questions[indexQuestion].length_min = res.data.data.length_min
                    self.examPart[indexPart].questions[indexQuestion].length_max = res.data.data.length_max
                    self.examPart[indexPart].questions[indexQuestion].status = res.data.data.status
        ...
        editItem(questionid, partid) {
            ...
            this.questionEditModalData = JSON.parse(JSON.stringify({
                ...
                length_min: this.examPart[indexpart].questions[index].length_min,
                length_max: this.examPart[indexpart].questions[index].length_max,
                status: this.examPart[indexpart].questions[index].status,
            }))
        ...
        addQuestion() {
            ...
            this.$http
                .post("/add-questions", {
                    ...
                    length_min: this.questionModalData.length_min,
                    length_max: this.questionModalData.length_max,
