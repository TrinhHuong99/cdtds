      ...
      >
        ...
        >
          <div class="">
            ...
            <div v-if="listItem.content_type == 4" class="question-item" >
              <div class="question-content type-note ql-editor" v-html="listItem.content" />
              <div class="question-content type-note ql-editor" v-html="listItem.answers" />
            </div>
            <div v-if="listItem.content_type == 5" class="question-item" >
              <div
        ...
        getTestInfo() {
            ...
            .then(res => {
                if (res.data.code === 1) {
                    ...
                    this.testDetail = this.testData.test_data
                }
            })
        }
    }
